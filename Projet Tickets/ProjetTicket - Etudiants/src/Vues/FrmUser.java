...
public class FrmUser extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        dtmTicket = (DefaultTableModel) tblTickets.getModel();
            FonctionsMetier fm = new FonctionsMetier();

        for(Ticket tic : fm.GetAllTicketsByIdUser(leUser.getIdUser()))
        {
            v = new Vector();
            v.add(tic.getIdTicket());
            v.add(tic.getNomTicket());
            v.add(tic.getDateTicket());
            v.add(tic.getNomEtat());
            dtmTicket.addRow(v);

        }
        tblTickets.setModel(dtmTicket);
